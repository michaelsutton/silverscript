...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        ...
        SizeSnapshot {
            ...
            expected_script_len: 2865,
            expected_sigscript_len: 10424,
            expected_instruction_count: 2195,
            expected_charged_op_count: 1429,
        },
        SizeSnapshot {
            name: "chess_pawn.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1972,
            expected_sigscript_len: 3193,
